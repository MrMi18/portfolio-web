...
export default function Skills() {
  ...
  const skillCategories = [
    ...
    {
      name: "Tools & DevOps",
      skills: ["Git", "Github", "Docker", "Vercel", "NPM", "ESLint", "Postman", "Render", "Netlify"],
  ...
  return (
    <div className="space-y-8 scroll-reveal" ref={scrollRef}>
      ...
      <div className="bg-gray-800/30 rounded-lg p-6 border border-gray-700/30">
        <p className="text-white/80 leading-relaxed">
          ...
          focusing on scalable web applications, API development, and database design. Experienced in Data Structures & Algorithms and Agile development methodologies.
        </p>
      </div>
    </div>
  );
